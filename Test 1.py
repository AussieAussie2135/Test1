...
# ... MathQuizApp class definition and methods ...
class MathQuizApp:
    ...
    def create_widgets(self):
        self.topic_label = ttk.Label(self.root, text="Choose a math topic:")
        ...
        self.num_questions_label = ttk.Label(self.root, text="Enter the number of questions:")
        self.num_questions_label.pack(pady=5)

        self.num_questions_entry = ttk.Entry(self.root)
        self.num_questions_entry.pack()

        self.generate_button = ttk.Button(self.root, text="Start Quiz", command=self.start_quiz)
        self.generate_button.pack(pady=10)

        self.reset_button = ttk.Button(self.root, text="Reset Quiz", command=self.reset_quiz)
        self.reset_button.pack(pady=10)

        self.question_label = ttk.Label(self.root, text="", wraplength=400, font=("Helvetica", 14, "bold"))
        ...
        self.result_label = ttk.Label(self.root, text="", foreground="green", font=("Helvetica", 12, "bold"))
